...
\begin{figure}[htbp]
    ...
    % \includegraphics[width=0.85\textwidth]{figures/chap4/edge_deployment_bottleneck.png}
...
如图 \ref{fig:pruning_comparison} 的实验结果所示，经过微调恢复后，
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/chap4/fig_4_8_tbdr_optimization.pdf}
